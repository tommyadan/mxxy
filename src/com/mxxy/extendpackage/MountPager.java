...
//			sprite=player.getMont();		
	...
	protected void initView() {
		...
		ride.setText(player.isShowMount()?"下骑":"骑乘");
	}
	...
	public void ride(ActionEvent e){
		if(sprite!=null){
			...
			player.setMountCharacter(mountIndex);
			ride.setText(player.isShowMount()?"骑乘":"下骑");
			player.setShowMount(!player.isShowMount());
		}
	}
	/**坐骑编号*/
	...
	public void getListValue(int index,String value) {
		...
		String spritePath=string.substring(string.lastIndexOf(Constant.currentDir.charAt(Constant.currentDir.length()-1))+1, string.length())+"/mountstand.tcp";
