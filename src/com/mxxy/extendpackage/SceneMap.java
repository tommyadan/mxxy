...
final public class SceneMap extends AbstractPanelHandler{
	...
	protected void initView() {
		...
		panel.setBounds(Constant.WINDOW_WIDTH/2 -background.getWidth()/2, Constant.WINDOW_HEIGHT/2-background.getHeight()/2, background.getWidth(),background.getHeight());
